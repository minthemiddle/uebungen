...
const THEMES = [
  {
    ...
    items: [
      ...
      [5, "Muoio ", "di", ["di"], " fame."],
      [5, "Trema ", "di", ["di"], " paura."],
      [5, "La bambina piange ", "di", ["di"], " gioia."],
      ...
      [8, "Il tavolo è ", "di", ["di"], " legno."],
      [8, "La statua è ", "di", ["di"], " bronzo."],
      [8, "Un braccialetto ", "d'", ["d'", "di"], "oro non costa poco."],
      [9, "La porta ", "della", ["della", "di"], " casa è nuova."],
...

  {
    ...
    items: [
      ...
      [5, "Il gatto dorme sopra ", "al", ["al", "a"], " divano."],
      ...
      [8, "Mio nonno ", "a", ["a"], " vent'anni viveva in campagna."],
      ...
      [10, "Mi fermo ", "a", ["a"], " parlare con Luca."],
      [10, "Ti aiuto ", "a", ["a"], " pulire."],
      [10, "Ci ha invitati ", "a", ["a"], " mangiare."],
      [11, "Vado ", "a", ["a"], " piedi al lavoro."],
      [11, "In montagna andiamo ", "a", ["a"], " cavallo."],
      [11, "Preferisco andare ", "a", ["a"], " piedi."],
      [12, "La casa di Maria è ", "a", ["a"], " due piani."],
...

  {
    ...
    items: [
      ...
      [1, "Siamo tornati ", "da", ["da"], " Napoli ieri."],
      ...
      [3, "I ladri sono entrati ", "dalla", ["dalla", "da"], " finestra."],
      [3, "Passiamo ", "dal", ["dal", "da"], " centro per arrivare."],
      [3, "La luce passa ", "dalla", ["dalla", "da"], " tenda."],
      [3, "Scendiamo ", "dalle", ["dalle", "da"], " scale."],
      [3, "L'acqua esce ", "dal", ["dal", "da"], " rubinetto."],
      [4, "Il bar è aperto ", "dalle", ["dalle", "da"], " 7 alle 13."],
      [4, "Lavoro ", "dal", ["dal", "da"], " lunedì al venerdì."],
      [4, "La festa dura ", "dalle", ["dalle", "da"], " 18 a mezzanotte."],
      [4, "Le lezioni cominciano ", "dalle", ["dalle", "da"], " nove."],
      ...
      [7, "Grida ", "dalla", ["dalla", "da"], " gioia."],
      [7, "Piangere ", "dalle", ["dalle", "da"], " risate."],
      [7, "Saltava ", "dalla", ["dalla", "da"], " paura."],
      [7, "Non dormo ", "dalla", ["dalla", "da"], " felicità."],
...

  {
    ...
    items: [
      ...
      [3, "Il corso comincia ", "in", ["in"], " autunno."],
      [3, "Mio figlio è nato ", "nel", ["nel", "in"], " 2001."],
      [3, "La riunione è ", "in", ["in"], " marzo."],
      [3, "Ci siamo sposati ", "in", ["in"], " estate."],
      [3, "Napoleone è nato ", "nel", ["nel", "in"], " 1769."],
      [3, "Parto ", "in", ["in"], " primavera."],
      [3, "Il museo è stato fondato ", "nel", ["nel", "in"], " 1901."],
      [4, "Il treno arriva ", "in", ["in"], " due ore."],
      [4, "La pasta cuoce ", "in", ["in"], " dieci minuti."],
      [4, "Faccio i compiti ", "in", ["in"], " un'ora."],
      [4, "Il pacco arriverà ", "in", ["in"], " tre giorni."],
      [4, "Rifanno la strada ", "in", ["in"], " una settimana."],
      [4, "Leggo questo giornale ", "in", ["in"], " cinque minuti."],
      [4, "Traduco la lettera ", "in", ["in"], " un attimo."],
      [4, "Impara l'italiano ", "in", ["in"], " sei mesi."],
      [4, "Attraversiamo la città ", "in", ["in"], " mezz'ora."],
      ...
      [6, "La scultura è ", "in", ["in"], " marmo."],
      [6, "La bottiglia è ", "in", ["in"], " vetro."],
      [6, "Il giocattolo è ", "in", ["in"], " plastica."],
      [6, "Il vaso è ", "in", ["in"], " ceramica."],
      [6, "La camicia è ", "in", ["in"], " seta."],
      [6, "Il maglione è ", "in", ["in"], " lana."],
      [6, "L'orologio è ", "in", ["in"], " acciaio."],
      [6, "La cornice è ", "in", ["in"], " legno chiaro."],
    ],
  },

  {
    ...
    items: [
      [1, "Vado al lavoro ", "con", ["con"], " la macchina."],
      [1, "Viaggio ", "con", ["con"], " il treno regionale."],
      [1, "Arriviamo ", "con", ["con"], " l'aereo."],
      [1, "Andiamo a scuola ", "con", ["con"], " l'autobus."],
      [1, "Mi muovo ", "con", ["con"], " la bicicletta."],
      [1, "Attraversiamo il mare ", "con", ["con"], " la nave."],
      [1, "Preferisco viaggiare ", "con", ["con"], " gli autobus."],
      [1, "Torno a casa ", "con", ["con"], " la metro."],
      [1, "Va a fare la spesa ", "con", ["con"], " lo scooter."],
      [1, "Arriviamo in cima ", "con", ["con"], " la funivia."],
      ...
      [2, "Comunica ", "con", ["con"], " la mail."],
      [2, "Cerchiamo di contattarli ", "con", ["con"], " il computer."],
      [2, "Scrivo ai colleghi ", "con", ["con"], " l'app."],
      [2, "Ho avvisato tutti ", "con", ["con"], " una telefonata."],
      [2, "Il direttore parla ", "con", ["con"], " il microfono."],
      [2, "Diffondiamo la notizia ", "con", ["con"], " i social."],
      [3, "Lavoro ", "con", ["con"], " il computer."],
      ...
      [4, "Ordino la pizza ", "con", ["con"], " i funghi."],
      ...
      [5, "Prediligo il tè ", "con", ["con"], " il limone."],
      ...
      [5, "Il signore ", "con", ["con"], " gli occhiali è mio zio."],
...

  {
    ...
    items: [
      ...
      [1, "L'aquila vola ", "sulla", ["sulla", "su"], " cima."],
      [1, "I fiori sono ", "sulla", ["sulla", "su"], " finestra."],
      ...
      [1, "La sella è ", "sul", ["sul", "su"], " cavallo."],
      [1, "Il tetto è ", "sulla", ["sulla", "su"], " casa vecchia."],
      ...
      [2, "Riflettiamo molto ", "sulla", ["sulla", "su"], " scelta."],
...

  {
    ...
    items: [
      [1, "Il giocatore è caduto ", "per", ["per"], " terra."],
      [1, "Il ragazzo è rimasto ", "per", ["per"], " strada."],
      [1, "Il soldato è partito ", "per", ["per"], " il fronte."],
      [1, "Viaggiamo ", "per", ["per"], " mare."],
      [1, "Siamo andati ", "per", ["per"], " la città."],
      [1, "Il colpevole è fuggito ", "per", ["per"], " la campagna."],
      [1, "Il bambino gira ", "per", ["per"], " il giardino."],
      [2, "Siamo passati ", "per", ["per"], " il centro."],
      [2, "Il ladro è entrato ", "per", ["per"], " la finestra."],
      [2, "Passiamo ", "per", ["per"], " la piazza."],
      [2, "Il fiume scorre ", "per", ["per"], " la valle."],
      [2, "La luce entra ", "per", ["per"], " la porta."],
      [2, "L'aria passa ", "per", ["per"], " la fessura."],
      [2, "Andiamo ", "per", ["per"], " questa strada."],
      [3, "Ho abitato a Milano ", "per", ["per"], " tre anni."],
      [3, "Il seminario dura ", "per", ["per"], " una settimana."],
      ...
      [6, "Piange ", "per", ["per"], " la felicità."],
      [6, "Trema ", "per", ["per"], " l'emozione."],
      [6, "Ride ", "per", ["per"], " il nervosismo."],
      [6, "Urla ", "per", ["per"], " la rabbia."],
      [6, "Non dorme ", "per", ["per"], " l'ansia."],
      [6, "Tace ", "per", ["per"], " la paura."],
      [6, "Si sveglia ", "per", ["per"], " lo spavento."],
...

  {
    ...
    items: [
      [1, "L'area di sosta è ", "fra", ["tra", "fra"], " dieci chilometri."],
      [1, "Il prossimo paese è ", "fra", ["tra", "fra"], " pochi chilometri."],
      [1, "La cima è ", "fra", ["tra", "fra"], " cento metri."],
      [1, "La stazione è ", "fra", ["tra", "fra"], " due chilometri."],
      [1, "Il mare è ancora ", "fra", ["tra", "fra"], " cinquanta chilometri."],
      [1, "Devi girare a sinistra ", "tra", ["tra", "fra"], " un chilometro."],
      [1, "L'ufficio è ", "tra", ["tra", "fra"], " due fermate."],
      [1, "Il bivio è ", "fra", ["tra", "fra"], " qualche centinaio di metri."],
      [1, "Il confine è ", "fra", ["tra", "fra"], " tre chilometri."],
      [1, "Il parcheggio è ", "tra", ["tra", "fra"], " cento metri."],
      [1, "L'autostrada è ", "fra", ["tra", "fra"], " tre uscite."],
      [1, "Il villaggio è ", "tra", ["tra", "fra"], " cinque chilometri."],
      [1, "La banca è ", "fra", ["tra", "fra"], " due isolati."],
      [1, "Il sentiero è ", "fra", ["tra", "fra"], " trecento metri."],
      [1, "L'uscita è ", "tra", ["tra", "fra"], " mezzo chilometro."],
      [1, "La riserva è ", "fra", ["tra", "fra"], " cinquecento metri."],
      ...
      [2, "Il pagamento scade ", "fra", ["tra", "fra"], " una settimana e dieci giorni."],
      [2, "Il corso inizierà ", "tra", ["tra", "fra"], " febbraio e marzo."],
      [2, "Riceverai la risposta ", "fra", ["tra", "fra"], " un giorno o due."],
...
function buildHtml(){
  ...
  const hint = "Welche Präposition fehlt? Tippen und weiterklicken – die Regel erscheint erst nach der Antwort. Die Grundformen (di, a, da, in, con, su, per, tra, fra) werden akzeptiert.";
  const storeKey = "uebung.001-preposizione.v2";
